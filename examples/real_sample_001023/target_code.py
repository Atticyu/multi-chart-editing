  ...
  "charts": [
    {
      "chart_id": "chart_1",
      "chart_type": "scatter",
      "title": "Air Quality Environment real-v2 view 1",
      "data_source": {
        "dataset_id": "epa_annual_aqi_state",
        "processed_file": "processed/epa_airdata/epa_annual_aqi_state.csv"
      },
      "encodings": {
        "x": "days_with_aqi",
        "y": "good_days",
      ...
      "filters": [],
      "relation_tags": [
        "environment_monitoring_relation",
        "shared_entity",
        "shared_measure",
        "shared_time_axis",
        "source_epa_airdata",
        "theme_air_quality_environment"
      ],
      "role_hint": "real-v2 air_quality_environment subplot 1",
      ...
      "visual_template": {
        ...
        "family": "scatter_family",
        "selection_policy": "deterministic mixed cluster assignment plus bounded continuous parameter sampling"
      },
      "data_transform": {
        "transform_id": "normalize_measure",
        "measure": "good_days",
        "method": "minmax",
        "description": "Transform the selected measure to a normalized analytical scale.",
    ...
    },
    {
      ...
      "title": "Air Quality Environment real-v2 view 2",
      "data_source": {
        "dataset_id": "epa_annual_aqi_county",
        "processed_file": "processed/epa_airdata/epa_annual_aqi_county.csv"
      },
      "encodings": {
        "x": "days_with_aqi",
        "y": "days_with_aqi",
      ...
      "role_hint": "real-v2 air_quality_environment subplot 2",
      "llm_generation_notes": [
        "Use the referenced processed CSV file.",
        "Use matplotlib, seaborn, or pandas plotting APIs.",
        "Keep labels readable and avoid overlapping legends.",
      ...
      "visual_template": {
        "cluster_id": "strip_jitter_compact",
        "alpha": 0.501,
        "size": 25.523,
        "jitter": 0.19,
        "rotation": 37,
        ...
        "family": "empirical_distribution_family",
        "selection_policy": "deterministic mixed cluster assignment plus bounded continuous parameter sampling"
      },
      "data_transform": {
        "transform_id": "identity",
        "description": "Use the filtered real data directly.",
        "selection_policy": "deterministic data-transform sampling constrained by chart type and encodings",
        "seed": 20407122
      }
    },
    {
      ...
      "title": "Air Quality Environment real-v2 view 3",
      "data_source": {
        "dataset_id": "epa_annual_aqi_state",
        "processed_file": "processed/epa_airdata/epa_annual_aqi_state.csv"
      },
      ...
      "role_hint": "real-v2 air_quality_environment subplot 3",
      "llm_generation_notes": [
        "Use the referenced processed CSV file.",
        "Use matplotlib, seaborn, or pandas plotting APIs.",
        "Keep labels readable and avoid overlapping legends.",
      ...
      "visual_template": {
        "cluster_id": "errorbar_caps_emphasis",
        "bar_alpha": 0.624,
        "line_marker": "o",
        "line_width": 1.957,
        "grid_alpha": 0.161,
...
OPERATIONS = json.loads(r'''[
  ...
  {
    "operation": "set_y_scale",
    "scale": "log",
    "scope": "numeric_y_charts"
  },
  {
    "operation": "preserve_unrelated_charts",
    "scope": "charts_not_in_dataset",
    "dataset_id": "epa_annual_aqi_state"
  }
]''')
